    ...
    public SellerController(ProductValidator productValidator, ProductService productService, CategoryRepository categoryRepository) {
       ...
       public String Seller(Model model){
          ...
          // model.addAttribute("products", productService.getAllProduct());
           model.addAttribute("products", productService.findAllProductsBySeller(login));
...
*/
    ...
    public String editProduct(@ModelAttribute("editProduct") Product product, BindingResult bindingResult, @PathVariable("id") int id,Model model){
